...
NOTE: Amennyiben törlünk egy kérdést a kérdésbankból és azt felhasználtuk már tesztben, akkor a tesztből nem fog törlődni a kérdés.
...
Alapjegy::::
Alapértelmezésben minden kérdésnél *1*, ennek segítségével adhatunk súlyt egy-egy fontosabb kérdésnek a vizsgán belül.
